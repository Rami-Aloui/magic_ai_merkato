        ...
        Route::prefix('user')->name('user.')->group(function () {
            ...
            Route::prefix('openai')->name('openai.')
                ->group(function () {
                    ...
                    //merkado
                    Route::prefix('merkado')->name('merkado.')->group(function () {
                        Route::get('/all', [UserController::class, 'merkadoAll'])->name('all');
                        Route::get('/all/coca-cola', [UserController::class, 'merkadoCola'])->name('all.coca-cola');
                    });
