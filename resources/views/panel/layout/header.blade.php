        ...
        <div class="container-fluid p-0 max-lg:w-full">
            ...
            <div class="navbar-collapse collapse" id="navbar-menu">
                <ul class="primary-nav navbar-nav max-lg:px-3 max-lg:py-4">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ activeRoute('dashboard.user.openai.merkado.*') }}"
                            href="{{ route('dashboard.user.openai.merkado.all') }}">
                            <span class="nav-link-icon">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
<g clip-path="url(#clip0_1607_7573)">
<path d="M8.1077 12.158C8.52379 12.3764 8.99746 12.5 9.5 12.5C10.3284 12.5 11.0784 12.1642 11.6213 11.6213M8.1077 12.158C7.15194 11.6564 6.5 10.6543 6.5 9.5C6.5 7.84315 7.84315 6.5 9.5 6.5C11.1569 6.5 12.5 7.84315 12.5 9.5C12.5 10.3284 12.1642 11.0784 11.6213 11.6213M8.1077 12.158L5.3923 17.342M5.3923 17.342C4.97621 17.1236 4.50254 17 4 17C2.34315 17 1 18.3431 1 20C1 21.6569 2.34315 23 4 23C5.65685 23 7 21.6569 7 20C7 18.8457 6.34806 17.8436 5.3923 17.342ZM11.6213 11.6213L14.8787 14.8787M14.8787 14.8787C14.3358 15.4216 14 16.1716 14 17C14 18.6569 15.3431 20 17 20C18.6569 20 20 18.6569 20 17C20 15.5751 19.0067 14.3823 17.6747 14.0762M14.8787 14.8787C15.4216 14.3358 16.1716 14 17 14C17.232 14 17.4579 14.0263 17.6747 14.0762M17.6747 14.0762L19.3253 6.92382M19.3253 6.92382C19.5421 6.97366 19.768 7 20 7C21.6569 7 23 5.65685 23 4C23 2.34315 21.6569 1 20 1C18.3431 1 17 2.34315 17 4C17 5.42485 17.9933 6.6177 19.3253 6.92382Z" stroke="black" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</g>
<defs>
